...
const ___dirname = path.join(typeof __dirname !== 'undefined' ? __dirname : path.dirname(fileURLToPath(import.meta.url)), './plugins')
...
const file = global.__filename(typeof __filename !== 'undefined' ? __filename : fileURLToPath(import.meta.url), true)
